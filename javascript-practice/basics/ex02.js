...
[객체2] - function type
1. new Function(...) 생성
2. ex) var f = function(){} 함수 리터럴1 사용해서 생성
3. ex) function f(){} 함수 리터럴1 사용해서 생성
...
/* 
 ...
 1. 내장(Built-In, Native, Engine) 객체
    자바 스크립트 엔진안에 미리 내재되어 있는 객체
    ex) Number, Boolean, Date, RegExp, ... : 생성자 함수
        parseInt, setTimeout, ...          : 일반함수

 2. 호스트 객체
    자바 스크립트 엔진이 임베디드된 환경(호스트)의 객체(자바스크립트 접근 가능)
...
var u = undefined; // var u; 와 동일, 선언과 정의가 동일
var i = 10;
var s = "Hello World";
var b = true;
...
console.log("======= 원시타입과 원시 타입을 Wrapper객체는 구분없이 사용 할 수 있다. =======================");
console.log(i + i2);
console.log(s + s2);
