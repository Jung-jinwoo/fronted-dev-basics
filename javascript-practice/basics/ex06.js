/*
    자바스크립트 객체1: object type

    1. 자바 스크립트 객체는 object, function 두 가지가 있다.
    2. 보통, function 타입 객체는 '함수'라 부른다.
    3. 따라서 자바스크립트에서 우리가 흔히 객체라 부르는 것은 object type의 객체라 할 수 있다.
*/

// 생성방법 1
// 생성자 함수를 사용하는 방법
// Object, Number, String, RegExp, Date, Array - 내장 생성자 함수 객체
// 그리고 사용자 정의 생성자 함수
var o1 = new Object();
o1.name = '둘리';
o1.age = 10;
